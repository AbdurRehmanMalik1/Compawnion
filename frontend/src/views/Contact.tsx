...
const ContactUs = () => {
  return (
    <div className="font-sans scroll-smooth bg-gradient-to-r from-[#c6fadc] to-[#b1553b] min-h-screen w-screen overflow-x-hidden text-[var(--color-primary-dark)] pb-20">
      ...
      <section className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-8 text-[#333]">
        ...
        <ul className="space-y-4">
          {[
            ...
            <li key={email} className="flex items-center justify-between border-b pb-2">
