import { EventHandler, FormEventHandler, ReactEventHandler } from "react";
...
const Login = () => {
    ...
    return (
        <div className="flex justify-center md:grid md:grid-cols-[1fr_600px]">
            ...
            <form onSubmit={submitForm} className="box-border px-4 sm:px-0 w-[90%] sm:w-[60%] flex flex-col gap-y-14 m-auto mt-5 text-sm sm:text-2sm ">
                <div>
