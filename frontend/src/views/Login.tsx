...
const Login = () => {
    ...
    const CenterLeftPageButton: string = `${LinkStyle} w-16 bg-[var(--color-primary)] rounded-bl-xl rounded-tl-xl px-3 py-3`;
    const CenterLeftActivePageButton: string = `${LinkStyle} w-16  bg-[var(--color-secondary)] rounded-bl-xl rounded-tl-xl px-3 py-3`;
    const CenterRightPageButton: string = `${LinkStyle} w-16 bg-[var(--color-primary)] rounded-br-xl rounded-tr-xl px-3 py-3`;
    const CenterRightActivePageButton: string = `${LinkStyle} w-16 bg-[var(--color-secondary)] rounded-br-xl rounded-tr-xl px-3 py-3`;
    ...
    return (
        <div className="flex justify-center md:grid md:grid-cols-[1fr_600px]">
            ...
            <form onSubmit={submitForm} className="relative box-border sm:px-0 w-[70%] sm:w-[60%] flex flex-col gap-y-12 md:gap-y-14 m-auto mt-5 text-sm sm:text-2sm ">
