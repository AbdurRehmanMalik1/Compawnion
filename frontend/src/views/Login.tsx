...
const Login = () => {
    ...
    const PageButton: string = `${LinkStyle} bg-[var(--color-primary)] rounded-bl-xl rounded-tl-xl px-2 py-1`;
    const ActivePageButton: string = `${LinkStyle} bg-[var(--color-secondary)] rounded-bl-xl rounded-tl-xl px-2 py-1`;
    ...
    return (
        <div className="flex justify-center md:grid md:grid-cols-[1fr_600px]">
            <div className="bg-black hidden md:flex md:flex-row relative">
                ...
                <div className="absolute top-[15%] right-0 text-white flex flex-col items-end gap-y-2 items-stretch">
